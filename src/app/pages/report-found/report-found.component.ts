        ...
        <div class="col-lg-8">
          <div class="glass-panel p-5 shadow-lg">
            ...
            <div class="d-flex align-items-center mb-4">
              ...
              <div>
                <h2 class="text-white fw-bold mb-0">Report Found Item</h2>
                <p class="text-muted small mb-0">Register details of the item you discovered. Our AI system will notify missing owner matches instantly.</p>
              </div>
            </div>
            ...
            <!-- Form -->
            <form [formGroup]="foundForm" (ngSubmit)="onSubmit()">
              <div class="row g-3">
                
                <!-- Item Name -->
                <div class="col-md-6">
                  <label class="form-label small" for="name">Item Name / Title</label>
                  <input type="text" id="name" formControlName="name" class="form-control" placeholder="e.g. Grey Laptop, Keyring with Fob"
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" id="brand" formControlName="brand" class="form-control" placeholder="e.g. Dell, Fossil, Unknown"
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" id="color" formControlName="color" class="form-control" placeholder="e.g. Dark Grey, Silver, Blue"
                ...
                <!-- Date Found -->
                <div class="col-md-6">
                  <label class="form-label small" for="date">Found Date</label>
                  ...
                  <div *ngIf="submitted && f['date'].errors" class="invalid-feedback">
                    Please specify when the item was discovered.
                  </div>
                </div>

                <!-- Found Location -->
                <div class="col-md-6">
                  <label class="form-label small" for="location">Found Location</label>
                  <input type="text" id="location" formControlName="location" class="form-control" placeholder="e.g. Cafe district, Train platform 3"
                    [class.is-invalid]="submitted && f['location'].errors">
                  <div *ngIf="submitted && f['location'].errors" class="invalid-feedback">
                    Discovered location details are required.
                  </div>
                </div>
                ...
                <div class="col-12">
                  ...
                  <textarea id="description" formControlName="description" rows="3" class="form-control" 
                    placeholder="Describe markings, labels, lockscreen stickers, keys count..."
                ...
                <div class="col-12 mt-4 d-flex justify-content-end gap-3">
                  ...
                  <button type="submit" class="btn btn-secondary-gradient px-4" [disabled]="loading">
...
export class ReportFoundComponent {
  ...
  get f() { return this.foundForm.controls; }
  ...
  suggestTags(): void {
    const name = this.foundForm.get('name')?.value || '';
    const desc = this.foundForm.get('description')?.value || '';
    const brand = this.foundForm.get('brand')?.value || '';
    const color = this.foundForm.get('color')?.value || '';
  ...
  onSubmit(): void {
    ...
    this.itemService.reportItem({
      ...
      next: () => {
        this.loading = false;
        this.successMessage = 'Found item reported successfully! Running AI Match Scanner...';
        setTimeout(() => {
